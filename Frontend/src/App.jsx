...
const App = () => {
    return (
        <body>
            <header>
                <h1>Welcome to CHS Source!</h1>
                <h2>Your place for independent venue schedules</h2>
                <p>
                    If you would like your venue added to this list, please contact the webmaster.
                </p>
            </header>
            <main>
            ...
            <footer>
                <a href="https://unfirthman.github.io/new-hanf-react-portfolio/">
                    Designed by michael hanf.
                </a>
            </footer>
        </body>
    );
